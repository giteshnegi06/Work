...
export const ScrollStackItem = ({ children }) => (
  <div className="scroll-stack-card bg-linear-to-b from-gray-600 via-gray-800 to-black rounded-4xl shadow-xl p-5 w-screen h-100 md:h-80 lg:h-90 lg:w-250 xl:h-110 xl:w-330 2xl:h-120  2xl:w-350 flex flex-col justify-center align-middle ">
    {children}
  </div>
);
...
const ScrollStack = ({ children, onComplete }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-900 md:h-780 lg:h-880 xl:h-1080 2xl:h-1150 bg-[#060010] flex flex-col items-center py-15 xl:py-25 -z-50 overflow-hidden"
    >
