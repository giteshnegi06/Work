...
export default function Portfolio() {
  const wedding = [
    {
      ...
      alt: "Taranveer Singh & Bhupinder Kaur",
  ...
  const preWedding = [
    {
      slug: "amit-tanvi",
      image:
        "https://res.cloudinary.com/dbtlo70e5/image/upload/v1772378530/5_r0yfxo.jpg",
      alt: "Image 1",
      title: "Amit & Tanvi",
    },
  ];
  ...
  return (
    <>
      ...
      <div>
        <img
          src="https://res.cloudinary.com/dbtlo70e5/image/upload/v1772474708/753_bzn068.jpg"
          alt="Pre-Wedding Shoot by Mahak Studio"
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10 md:px-4 mt-10">
            {preWedding.map((v, i) => (
              <Link key={i} to={`/wedding/${v.slug}`}>
                {" "}
                {/* Fixed: used v.slug instead of wedding.slug */}
                <div className="group relative w-70 h-105 rounded-2xl overflow-hidden cursor-pointer">
                  <img
                    src={v.image}
                    alt={v.alt}
